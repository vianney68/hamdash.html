const topBarCenterText = `F4JSG - JN38PA`;
// Menu items
...
const aURL = [
  ...
  [
    "2196F3",
    "FOUDRE",
    "https://map.blitzortung.org/#5.06/45.99/5.41",
    "1",
    "R",
  ],
...
const aIMG = [
  ["RADAR", "https://www.meteo60.fr/radars/animation-radar-france.gif"],
  [
    "LOCAL RADAR",
    "https://www.meteociel.fr/cartes_obs/vent.png",
  ],
  [
    "NOAA D-RAP",
  ...
  [
    "SATELLITE CAN",
    "https://neige.meteociel.fr/satellite/latest-vis.jpg",
  ],
  [
    "SATELLITE CGL",
    "https://neige.meteociel.fr/satellite/anim_ir.gif",
  ],
  [
    "LIGHTNING",
  ...
  ["GREY LINE", "https://www.timeanddate.com/scripts/sunmap.php?iso=&earth=1"],
  [
    "SW BROADCAST",
